...
<body class="backgrounds">
    <header class="pt-1 px-4 w-100 navbar-expand-xl bg-dark shadows fixed-top">
        ...
        $query_check = $conn->prepare("SELECT COUNT(*) FROM locations WHERE location_name = :location_name");
        ...
        if ($count > 0) {
            ...
            echo '</script>';
            return "มีชื่อสถานที่นี้อยู่แล้ว";
        }
        else{
            $Addlocations = new Location();
                        ...
                        if ($result === true) {
                            ...
                            echo '<script type="text/javascript">';
                            echo 'Swal.fire("Success", "Location added successfully!", "success");';
                            echo '</script>';
                        } else {
                            ...
                            <div class="modal-content">
                                ...
                                <form method="post" enctype="multipart/form-data" class="p-4">
                                    <div class="d-flex gap-2">
                                        <select id="categoryDropdown" required class="form-select option-container text-center rounded-pill mt-1 w-50 " name="category">
                                            <option value="" disabled selected>หมวดหมู่</option>
                                            <option value="clothing">Clothing</option>
                                            <option value="travel">Travel</option>
                                            <option value="food">Food</option>
                                        </select>
                                        <select id="locationDropdown" required class="form-select option-container text-center rounded-pill mt-1 w-50" name="location">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form method="post" enctype="multipart/form-data" class="p-4">
                        ...
                        <div class="w-100 mx-auto mt-2 d-flex">
                            <button name="addlocation" type="submit" class="btn btn-primary mx-auto" id="post_button" value="Post">
                                <div class="text-center">ยืนยัน</div>
                            </button>
                        </div>
